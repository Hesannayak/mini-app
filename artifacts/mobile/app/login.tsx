...
const s = StyleSheet.create({
  ...
  phoneRow: { flexDirection: 'row', marginTop: 20, marginBottom: 24, gap: 10 },
  prefixBox: {
  ...
  prefixText: { color: '#8B8BAD', fontSize: 15, fontWeight: '600', fontFamily: 'Inter_600SemiBold' },
  phoneInput: {
    flex: 1, backgroundColor: '#14142A', borderRadius: 14,
    borderWidth: 1.5, borderColor: '#1E2040',
    paddingHorizontal: 18, paddingVertical: 18,
    color: '#EEF2FF', fontSize: 20, fontWeight: '600',
    letterSpacing: 2, fontFamily: 'Inter_600SemiBold',
    ...(Platform.OS === 'web' ? { outlineStyle: 'none' as any } : {}),
  },

  otpRow: { flexDirection: 'row', gap: 8, marginTop: 24, marginBottom: 28 },
  otpBox: {
    flex: 1, height: 60, backgroundColor: '#14142A',
    borderRadius: 14, borderWidth: 1.5, borderColor: '#1E2040',
    textAlign: 'center', color: '#EEF2FF',
    fontSize: 24, fontWeight: '700', fontFamily: 'Inter_700Bold',
    ...(Platform.OS === 'web' ? { outlineStyle: 'none' as any } : {}),
  },
